...
workshop-pvc   Bound    ...      1Gi        RWO            ...            10s
----
+
...
. View the TaskRun detail in the OpenShift console. In the **Developer** perspective, navigate to **Pipelines**, then **TaskRuns**. Click `build-coolstuff-run-01` to see each step and its log output side by side.

// TODO: Add screenshot of the TaskRun detail page showing all 3 steps with log output
image::taskrun-multistep-logs.png[OpenShift console TaskRun detail showing validate, test, and package steps with their log output,link=self,window=blank,width=700,title="Multi-step TaskRun with data flowing through the Workspace"]
...
. View the TaskRuns list in the **Developer** perspective under **Pipelines**, then **TaskRuns**.

// TODO: Add screenshot of the TaskRuns list in the OpenShift console showing both build TaskRuns with Succeeded status
...
Confirm both TaskRuns completed successfully:
...
. `content/modules/ROOT/assets/images/taskrun-multistep-logs.png` -- OpenShift console TaskRun detail showing validate, test, and package steps with their log output (clickable full-size)
. `content/modules/ROOT/assets/images/taskrun-list-console.png` -- OpenShift console TaskRuns list showing both build TaskRuns with Succeeded status (clickable full-size)
