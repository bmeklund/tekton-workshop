...
* A Terminal with the OpenShift CLI and the Tekton CLI installed

NOTE: All credentials and environment details will be provided and displayed in the lab guide.
