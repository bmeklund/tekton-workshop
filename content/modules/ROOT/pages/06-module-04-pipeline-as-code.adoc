...
. Scroll down to the bottom of the page andSet the commit message to `Add PAC pipeline definition`
...
+
. Click **Comment** and type `/retest` in the comment body and submit.
+
